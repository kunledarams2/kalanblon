            ...
            body: (state is LoadedDetailProfileState)
                ? NestedScrollView(
                    ...
                    headerSliverBuilder:
                      ...
                      var name = (_bloc.account.meta.first_name != '' &&
                              _bloc.account.meta.last_name != '')
                          ? "${_bloc.account.meta.first_name} ${_bloc.account.meta.last_name}"
                          : _bloc.account.login;
                      return <Widget>[
                        SliverAppBar(
  ...
  Widget getBody(state) {
    if (state is LoadedDetailProfileState) {
      if (state.isTeacher) {
        ...
        if (_bloc.account.meta.description != null &&
            _bloc.account.meta.description.isNotEmpty) {
          return Padding(
            padding: const EdgeInsets.all(32.0),
            child: Text(
              _bloc.account.meta.description,
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  textScaleFactor: 1.0,
                  style: TextStyle(
                      color: HexColor.fromHex("#D7DAE2"), fontSize: 18),
                ),
                Padding(
