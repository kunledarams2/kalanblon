...
class _TrendingWidget extends State<TrendingWidget> {
  ...
  _buildItem(context, image, List<Category> category, title, stars, reviews,
      price, oldPrice, free) {
    var unescape = new HtmlUnescape();

    String categoryName = (category != null && category.isNotEmpty)
        ? "${unescape.convert(category.first.name)} >"
        : "";
    return SizedBox(
      width: 170,
      child: Container(
